...
voorspelling_correct boolean -- Klopt de voorspelling (bevestigd door het persoon zelf).
...
insert into vragenlijst_data(social_media, mp3_speler, krant, telefoon, bellen_of_email, smileys) values(0,1,1,2,1,1);